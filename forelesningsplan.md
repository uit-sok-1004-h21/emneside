...
|F11  | Case 3: Analyse av korrelasjonen mellom økonomisk aktivitet (BNP), CO2-utslipp og global temperatur  | ØM | [lenker til case og R kode](lenker_til_case_og_R_kode.md){:target='_blank_'}  |
...
|F16   | Case 6: Analyse av den historiske reallønnsveksten i Norge                 | ØM       |  [lenker til case og R kode](lenker_til_case_og_R_kode.md){:target='_blank_'} |
